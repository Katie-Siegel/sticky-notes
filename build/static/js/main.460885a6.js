/*! For license information please see main.460885a6.js.LICENSE.txt */
(() => {
  "use strict";
  var e = {
      3: (e, t, n) => {
      ...
      866: (e, t, n) => {
        ...
        var Mt = !1;
        function It() {
          Pt && (Pt.detachEvent("onpropertychange", Dt), (Nt = Pt = null));
        }
        function Dt(e) {
          "value" === e.propertyName &&
            Rt(Nt) &&
            Fe(Ot, (e = Ct(Nt, e, je(e))));
        }
        function Ut(e, t, n) {
          "focus" === e
            ? (It(), (Nt = n), (Pt = t).attachEvent("onpropertychange", Dt))
            : "blur" === e && It();
        }
        function Ft(e) {
        ...
        function jr(e, t, n) {
          Mr.current !== zr && a("168"), Rr(Mr, t), Rr(Ir, n);
        }
        function Wr(e, t, n) {
          var r = e.stateNode;
          if (
        ...
        function pl(e, t, n, r) {
          ...
          "object" === typeof i && null !== i
            ? (l.context = Hi(i))
            : ((i = Fr(t) ? Dr : Mr.current), (l.context = Ur(e, i))),
            null !== (i = e.updateQueue) &&
              (la(e, i, n, l, r), (l.state = e.memoizedState)),
        ...
        function yl(e) {
          ...
          function d(e, t, n) {
            ...
            if ("object" === typeof t && null !== t) {
              ...
              if (ml(t) || ot(t))
                return ((t = Jr(t, e.mode, n, null)).return = e), t;
              vl(e, t);
            }
            return null;
          }
          ...
          return function (e, r, i, u) {
              ...
              switch (i.$$typeof) {
                case qe:
                  e: {
                    ...
                    i.type === Xe
                      ? (((r = Jr(i.props.children, e.mode, u, i.key)).return =
                          e),
                        (e = r))
                      : (((u = Gr(
                          i.type,
            ...
            if ((s && vl(e, i), "undefined" === typeof i && !c))
              switch (e.tag) {
                case 1:
                case 0:
        ...
        function Zl(e, t, n, r, l, i) {
          if (
            ((Ll = i),
            (Al = t),
            (Wl = null !== e ? e.memoizedState : null),
            (Fl.current = null === Wl ? di : pi),
            (t = n(r, l)),
            ql)
          ) {
            do {
          ...
          return (
            (Fl.current = fi),
            ((e = Al).memoizedState = Vl),
            (e.expirationTime = $l),
            (e.updateQueue = Ql),
            (e.effectTag |= Kl),
            (e = null !== jl && null !== jl.next),
            (Ll = 0),
            (Hl = Bl = Vl = Wl = jl = Al = null),
            ($l = 0),
            (Ql = null),
            (Kl = 0),
            e && a("300"),
        ...
        function ti() {
          ...
          return null === Bl ? (Vl = Bl = e) : (Bl = Bl.next = e), Bl;
        }
        function ni() {
          if (null !== Hl)
            (Hl = (Bl = Hl).next), (Wl = null !== (jl = Wl) ? jl.next : null);
          else {
            null === Wl && a("310");
            var e = {
              memoizedState: (jl = Wl).memoizedState,
              baseState: jl.baseState,
              queue: jl.queue,
              baseUpdate: jl.baseUpdate,
              next: null,
            };
            (Bl = null === Bl ? (Vl = e) : (Bl.next = e)), (Wl = jl.next);
          }
          return Bl;
        }
        function ri(e, t) {
        ...
        function li(e) {
          var t = ni(),
            n = t.queue;
          if ((null === n && a("311"), (n.lastRenderedReducer = e), 0 < Xl)) {
            var r = n.dispatch;
            if (null !== Yl) {
              var l = Yl.get(n);
              if (void 0 !== l) {
        ...
        function ii(e, t, n, r) {
          return (
            ...
            null === Ql
              ? ((Ql = { lastEffect: null }).lastEffect = e.next = e)
              : null === (t = Ql.lastEffect)
              ? (Ql.lastEffect = e.next = e)
              : ((n = t.next), (t.next = e), (e.next = n), (Ql.lastEffect = e)),
            e
          );
        }
        function ai(e, t, n, r) {
          var l = ti();
          (Kl |= e),
            (l.memoizedState = ii(t, n, void 0, void 0 === r ? null : r));
        }
        function oi(e, t, n, r) {
          var l = ni();
          r = void 0 === r ? null : r;
          var i = void 0;
          if (null !== jl) {
            var a = jl.memoizedState;
            if (((i = a.destroy), null !== r && Jl(r, a.deps)))
              return void ii(Nl, n, i, r);
          }
          (Kl |= e), (l.memoizedState = ii(t, n, i, r));
        }
        function ui(e, t) {
            ...
            if (
              ...
              try {
                var c = t.lastRenderedState,
                  s = r(c, n);
                if (((i.eagerReducer = r), (i.eagerState = s), Zt(s, c)))
                  return;
              } catch (f) {}
            no(e, l);
          }
        ...
        var fi = {
          ...
          di = {
            ...
            useContext: Hi,
            useEffect: function (e, t) {
              return ai(516, Ul | Dl, e, t);
            },
            useImperativeHandle: function (e, t, n) {
              return (
                (n = null !== n && void 0 !== n ? n.concat([e]) : null),
                ai(4, Rl | Il, ui.bind(null, t, e), n)
              );
            },
            useLayoutEffect: function (e, t) {
              return ai(4, Rl | Il, e, t);
            },
            useMemo: function (e, t) {
              var n = ti();
              return (
          ...
          pi = {
            ...
            useCallback: function (e, t) {
              ...
              return null !== r && null !== t && Jl(t, r[1])
                ? r[0]
                : ((n.memoizedState = [e, t]), e);
            },
            useContext: Hi,
            useEffect: function (e, t) {
              return oi(516, Ul | Dl, e, t);
            },
            useImperativeHandle: function (e, t, n) {
              return (
                (n = null !== n && void 0 !== n ? n.concat([e]) : null),
                oi(4, Rl | Il, ui.bind(null, t, e), n)
              );
            },
            useLayoutEffect: function (e, t) {
              return oi(4, Rl | Il, e, t);
            },
            useMemo: function (e, t) {
              var n = ni();
              t = void 0 === t ? null : t;
        ...
        function xi(e) {
          ...
          if (
            ...
            for (t = hi; t; ) yi(e, t), (t = Er(t));
          return ki(e), (hi = mi ? Er(e.stateNode) : null), !0;
        }
        function wi() {
          (hi = mi = null), (vi = !1);
        }
        ...
        function Ei(e, t, n, r, l) {
          ...
          return (
            ...
            (r = Zl(e, t, n, r, i, l)),
            null === e || Si
              ? ((t.effectTag |= 1), _i(e, t, r, l), t.child)
          ...
          if (null === e) {
            ...
            return "function" !== typeof a ||
              ...
              ? (((e = Gr(n.type, null, r, null, t.mode, i)).ref = t.ref),
                (e.return = t),
                (t.child = e))
              : ((t.tag = 15), (t.type = a), Pi(e, t, a, r, l, i));
          }
          return (
            (a = e.child),
            l < i &&
        ...
        function Oi(e, t, n, r, l) {
          var i = Fr(n) ? Dr : Mr.current;
          return (
            (i = Ur(t, i)),
            Bi(t, l),
            (n = Zl(e, t, n, r, i, l)),
            null === e || Si
              ? ((t.effectTag |= 1), _i(e, t, n, l), t.child)
              : ((t.updateQueue = e.updateQueue),
                (t.effectTag &= -517),
                e.expirationTime <= l && (e.expirationTime = 0),
                Di(e, t, l))
        ...
        function Ri(e, t, n, r, l) {
          ...
          if ((Bi(t, l), null === t.stateNode))
            ...
            u = a.state = d;
            var p = t.updateQueue;
            null !== p && (la(t, p, r, a, l), (u = t.memoizedState)),
              o !== r || d !== u || Ir.current || Yi
                ? ("function" === typeof s &&
                    (ul(t, n, s, r), (u = t.memoizedState)),
                  (o = Yi || sl(t, n, o, r, d, u, c))
                    ? (f ||
            ...
            (a = t.stateNode),
              ...
              null !== (p = t.updateQueue) &&
                (la(t, p, r, a, l), (d = t.memoizedState)),
              o !== r || u !== d || Ir.current || Yi
                ? ("function" === typeof s &&
                    (ul(t, n, s, r), (d = t.memoizedState)),
                  (s = Yi || sl(t, n, o, r, u, d, c))
                    ? (f ||
        ...
        function zi(e, t, n, r, l, i) {
          ...
          if (!r && !a) return l && Br(t, n, !1), Di(e, t, i);
          ...
          switch (((t.expirationTime = 0), t.tag)) {
            case 2:
              ...
              if (
                ...
                "function" === typeof o && ul(t, r, o, e),
                  (l.updater = cl),
                  (t.stateNode = l),
                  (l._reactInternalFiber = t),
                  pl(t, r, e, n),
                  (t = zi(null, t, r, !0, i, n));
              } else (t.tag = 0), _i(null, t, l, n), (t = t.child);
              return t;
            case 16:
              switch (
                ((l = t.elementType),
            ...
            case 0:
              return (
                (r = t.type),
                (l = t.pendingProps),
                Oi(e, t, r, (l = t.elementType === r ? l : al(r, l)), n)
              );
            case 1:
              return (
                (r = t.type),
                (l = t.pendingProps),
                Ri(e, t, r, (l = t.elementType === r ? l : al(r, l)), n)
              );
            case 3:
              return (
                Mi(t),
                ...
                (r = t.memoizedState.element) === l
                  ...
                  : ((l = t.stateNode),
                    (l = (null === e || null === e.child) && l.hydrate) &&
                      ((hi = Cr(t.stateNode.containerInfo)),
                      (mi = t),
                      (l = vi = !0)),
                    l
            ...
            case 4:
              return (
                _l(t, t.stateNode.containerInfo),
                (r = t.pendingProps),
                null === e ? (t.child = gl(t, null, r, n)) : _i(e, t, r, n),
                t.child
              );
            case 11:
              return (
                (r = t.type),
                (l = t.pendingProps),
                Ei(e, t, r, (l = t.elementType === r ? l : al(r, l)), n)
              );
            case 7:
            ...
            case 9:
              return (
                ...
                Bi(t, n),
                (r = r((l = Hi(l, i.unstable_observedBits)))),
                (t.effectTag |= 1),
                _i(e, t, r, n),
                t.child
              );
        ...
        function Wi(e, t) {
          ...
          Rr(Fi, n._currentValue), (n._currentValue = t);
        }
        function Vi(e) {
          var t = Fi.current;
          Or(Fi), (e.type._context._currentValue = t);
        }
        function Bi(e, t) {
          (Li = e), (ji = Ai = null);
              ...
              null === r
                ? null === l
                  ? ((r = e.updateQueue = Xi(e.memoizedState)),
                    (l = n.updateQueue = Xi(n.memoizedState)))
                  : (r = e.updateQueue = Gi(l))
                : null === l && (l = n.updateQueue = Gi(r));
          null === l || r === l
            ? Zi(r, t)
        ...
        function va(e, t, n) {
          if (
            ...
            do {
              ...
              (r.tag & t) !== Nl && ((l = r.create), (r.destroy = l())),
                (r = r.next);
            } while (r !== n);
          }
        }
            ...
            case 13:
              if (
                ...
                null === n
                  ...
                  : ((r = !0),
                    (e = t.child),
                    0 === n.timedOutAt && (n.timedOutAt = Po())),
                null !== e &&
                  (function (e, t) {
                    for (var n = e; ; ) {
                      if (5 === n.tag) {
                ...
                t.updateQueue = null;
                var o = t.stateNode;
                null === o && (o = t.stateNode = new pa()),
                  n.forEach(function (e) {
                    var n = eo.bind(null, t, e);
        ...
        function Ta(e, t, n) {
          ((n = Ji(n)).tag = qi), (n.payload = { element: null });
          var r = t.value;
          return (
            (n.callback = function () {
              Lo(r), ma(e, t);
        ...
        function Wa() {
          ...
          (Ra = null), (za = 0), (Ma = -1), (Ia = !1), (Oa = null);
        }
        function Va() {
          for (; null !== Da; ) {
            var e = Da.effectTag;
            if ((16 & e && ur(Da.stateNode, ""), 128 & e)) {
              var t = Da.alternate;
              null !== t &&
                null !== (t = t.ref) &&
            ...
            switch (14 & e) {
              case 2:
                ...
                break;
              case 6:
                ba(Da), (Da.effectTag &= -3), xa(Da.alternate, Da);
                break;
              case 4:
                xa(Da.alternate, Da);
                break;
        ...
        function $a(e, t) {
          ...
          (uo = n),
            0 !== (n = e.expirationTime) && No(e, n),
            ho || uo || Io(1073741823, !1);
        }
        function Qa() {
          null !== La && _r(La), null !== Aa && Aa();
        }
        function Ka(e, t) {
          ...
          for (
            jn(br), br = null, _n = !!gr, gr = null, e.current = t, Da = r;
            null !== Da;
                    ...
                    if (((o = t.type), null !== i && null != t.stateNode))
                      ...
                      if (xi(t)) {
                        ...
                        switch (
                          ...
                          case "video":
                          case "audio":
                            for (f = 0; f < ne.length; f++) En(ne[f], i);
                            break;
                          case "source":
                            En("error", i);
                            break;
                          ...
                          case "details":
                            ...
                            break;
                          case "input":
                            xt(i, d), En("invalid", i), vr(p, "onChange");
                            break;
                          case "select":
                            ...
                            break;
                          case "textarea":
                            Jn(i, d), En("invalid", i), vr(p, "onChange");
                        }
                        for (o in (mr(c, d), (f = null), d))
                          d.hasOwnProperty(o) &&
                            ((s = d[o]),
                            "children" === o
                              ? "string" === typeof s
                                ...
                                : "number" === typeof s &&
                                  i.textContent !== "" + s &&
                                  (f = ["children", "" + s])
                              : k.hasOwnProperty(o) && null != s && vr(p, o));
                        switch (c) {
                          case "input":
                            Be(i), St(i, d, !0);
                            break;
                        ...
                        (o = f), (u.updateQueue = o), (u = null !== o) && ua(t);
                      } else {
                        (d = t),
                          (p = o),
                          (i = u),
        ...
        function Xa(e, t) {
          ...
          (r === za && e === Ra && null !== Oa) ||
            (Wa(),
            (za = r),
            (Oa = Xr((Ra = e).current, null)),
            (e.pendingCommitExpirationTime = 0));
          for (var l = !1; ; ) {
            try {
              if (t) for (; null !== Oa && !zo(); ) Oa = Ya(Oa);
              else for (; null !== Oa; ) Oa = Ya(Oa);
            } catch (y) {
              if (((ji = Ai = Li = null), ei(), null === Oa)) (l = !0), Lo(y);
              else {
                null === Oa && a("271");
                var i = Oa,
                  o = i.return;
                      ...
                      do {
                        if (
                          ...
                          null === v
                            ...
                            h.has(c) ||
                              (h.add(c),
                              (s = Za.bind(null, s, d, c)),
                              d.then(s, s)),
                            -1 === p
                              ? (u = 1073741823)
                              : (-1 === m &&
                                  (m = 10 * (1073741822 - ll(u, o)) - 5e3),
                                (u = m + p)),
                            0 <= u && Ma < u && (Ma = u),
                            (f.effectTag |= 2048),
                            (f.expirationTime = o);
          ...
          if (((Na = !1), (Ea.current = n), (ji = Ai = Li = null), ei(), l))
            (Ra = null), (e.finishedWork = null);
          else if (null !== Oa) e.finishedWork = null;
          else {
            if (
              (null === (n = e.current.alternate) && a("281"), (Ra = null), Ia)
            ) {
              if (
                ...
                return rl(e, r), void Eo(e, n, r, e.expirationTime, -1);
              if (!e.didError && t)
                return (
                  (e.didError = !0),
            ...
            t && -1 !== Ma
              ? (rl(e, r),
                (t = 10 * (1073741822 - ll(e, r))) < Ma && (Ma = t),
                (t = 10 * (1073741822 - Po())),
                (t = Ma - t),
                Eo(e, n, r, e.expirationTime, 0 > t ? 0 : t))
        ...
        function Ga(e, t) {
            ...
            switch (n.tag) {
              case 1:
                ...
                if (
                  ...
                  return (
                    ea(n, (e = Sa(n, (e = oa(t, e)), 1073741823))),
                    void no(n, 1073741823)
                  );
                break;
              case 3:
                return (
                  ea(n, (e = Ta(n, (e = oa(t, e)), 1073741823))),
                  void no(n, 1073741823)
                );
            }
            n = n.return;
          ...
          3 === e.tag &&
            (ea(e, (n = Ta(e, (n = oa(t, e)), 1073741823))), no(e, 1073741823));
        }
        function Ja(e, t) {
        ...
        function eo(e, t) {
          var n = e.stateNode;
          null !== n && n.delete(t),
            null !== (e = to(e, (t = Ja((t = Po()), e)))) &&
              (nl(e, t), 0 !== (t = e.expirationTime) && No(e, t));
        }
        function to(e, t) {
        ...
        function no(e, t) {
          null !== (e = to(e, t)) &&
            (!Na && 0 !== za && t > za && Wa(),
            nl(e, t),
            (Na && !Ua && Ra === e) || No(e, e.expirationTime),
            wo > xo && ((wo = 0), a("185")));
        }
        ...
        var lo = null,
          ...
          yo = null,
          go = i.unstable_now(),
          bo = 1073741822 - ((go / 10) | 0),
          ko = bo,
          xo = 50,
          wo = 0,
          To = null;
        function So() {
          bo = 1073741822 - (((i.unstable_now() - go) / 10) | 0);
        }
        function _o(e, t) {
          if (0 !== ao) {
            if (t < ao) return;
            null !== oo && i.unstable_cancelCallback(oo);
          }
          (ao = t),
            (e = i.unstable_now() - go),
            (oo = i.unstable_scheduleCallback(Mo, {
        ...
        function Eo(e, t, n, r, l) {
          (e.expirationTime = r),
            0 !== l || zo()
              ? 0 < l && (e.timeoutHandle = wr(Co.bind(null, e, t, n), l))
        ...
        function Po() {
          return uo || (Oo(), (0 !== so && 1 !== so) || (So(), (ko = bo))), ko;
        }
        function No(e, t) {
          null === e.nextScheduledRoot
            ? ((e.expirationTime = t),
              null === io
                ? ((lo = io = e), (e.nextScheduledRoot = e))
                : ((io = io.nextScheduledRoot = e).nextScheduledRoot = lo))
            : t > e.expirationTime && (e.expirationTime = t),
            uo ||
              (ho
                ? vo && ((co = e), (so = 1073741823), Uo(e, 1073741823, !1))
                : 1073741823 === t
                ? Io(1073741823, !1)
                : _o(e, t));
        }
        function Oo() {
          var e = 0,
            t = null;
          if (null !== io)
            for (var n = io, r = lo; null !== r; ) {
              var l = r.expirationTime;
              if (0 === l) {
                if (
                  ((null === n || null === io) && a("244"),
                  r === r.nextScheduledRoot)
                ) {
                  lo = io = r.nextScheduledRoot = null;
                  break;
                }
                if (r === lo)
                  (lo = l = r.nextScheduledRoot),
                    (io.nextScheduledRoot = l),
                    (r.nextScheduledRoot = null);
                else {
                  if (r === io) {
                    ((io = n).nextScheduledRoot = lo),
                      (r.nextScheduledRoot = null);
                    break;
                  }
        ...
        var Ro = !1;
        function zo() {
          return !!Ro || (!!i.unstable_shouldYield() && (Ro = !0));
        }
        function Mo() {
          try {
            if (!zo() && null !== lo) {
              ...
              do {
                ...
                0 !== t && bo <= t && (e.nextExpirationTimeToWorkOn = bo),
        ...
        function Io(e, t) {
          if ((Oo(), t))
            for (
              So(), ko = bo;
              null !== co && 0 !== so && e <= so && !(Ro && bo > so);

            )
              Uo(co, so, bo > so), Oo(), So(), (ko = bo);
          else
            for (; null !== co && 0 !== so && e <= so; ) Uo(co, so, !1), Oo();
          if (
            (t && ((ao = 0), (oo = null)),
            0 !== so && _o(co, so),
            (wo = 0),
          ...
          if (po) throw ((e = mo), (mo = null), (po = !1), e);
        }
        function Do(e, t) {
          uo && a("253"), (co = e), (so = t), Uo(e, t, !1), Io(1073741823, !1);
        }
        function Uo(e, t, n) {
          if ((uo && a("245"), (uo = !0), n)) {
            ...
            null !== (r = e.finishedWork)
              ...
              : ((e.finishedWork = null),
                -1 !== (r = e.timeoutHandle) && ((e.timeoutHandle = -1), Tr(r)),
                Xa(e, n),
                null !== (r = e.finishedWork) && Fo(e, r, t));
          uo = !1;
        }
        function Fo(e, t, n) {
          var r = e.firstBatch;
        ...
        function $o(e) {
          var t =
            1073741822 - 25 * (1 + (((1073741822 - Po() + 500) / 25) | 0));
          t >= Pa && (t = Pa - 1),
        ...
        (Ce = function (e, t, n) {
          ...
          ($o.prototype.render = function (e) {
            ...
            var t = this._root._internalRoot,
              ...
              r = new Qo();
            return Vo(e, t, null, n, r._onCommit), r;
          }),
        ...
        var Go = {
          ...
          hydrate: function (e, t, n) {
            return qo(t) || a("200"), Yo(null, e, t, !0, n);
          },
          render: function (e, t, n) {
            return qo(t) || a("200"), Yo(null, e, t, !1, n);
          },
          ...
          flushSync: function (e, t) {
            ...
            try {
              ...
              (ho = n), Io(1073741823, !1);
            }
          },
          unstable_createRoot: function (e, t) {
            return (
              qo(e) || a("299", "unstable_createRoot"),
              new Ko(e, !0, null != t && !0 === t.hydrate)
            );
          },
  ...
  const o = (e) =>
    ...
    c = (e) => {
      ...
      return l().createElement("ul", { className: "note-board" }, t);
    };
  class s extends r.Component {
    constructor() {
      super(...arguments),
        (this.state = {
          notes: [
            { id: Date.now(), title: "", description: "", doesMatchSearch: !0 },
          ],
          searchText: "",
        }),
        (this.addNote = (e) => {
          ...
          this.setState({ notes: [t, ...this.state.notes] });
        }),
        (this.onType = (e, t, n) => {
          const r = this.state.notes.map((r) =>
            r.id !== e
              ? r
              : "title" === t
              ? ((r.title = n), r)
            ...
            n = this.state.notes.map((e) => {
              if (t) {
                const n = e.title.toLowerCase(),
                  ...
                  i = r.includes(t),
                  a = l || i;
                return (e.doesMatchSearch = a), e;
              }
              return (e.doesMatchSearch = !0), e;
            });
          this.setState({ notes: n, searchText: t });
        }),
        (this.removeNote = (e) => {
          const t = this.state.notes.filter((t) => t.id !== e);
          this.setState({ notes: t });
        });
    }
    componentDidUpdate() {
      const e = JSON.stringify(this.state.notes);
      localStorage.setItem("savedNotes", e);
    }
    componentDidMount() {
      const e = localStorage.getItem("savedNotes");
      if (e) {
  ...
  a().render(l().createElement(f, null), d);
})();
//# sourceMappingURL=main.460885a6.js.map
